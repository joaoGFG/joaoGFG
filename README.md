...
I’m a second-year Systems Analysis and Development student at FIAP, building my journey with curiosity and dedication. I’ve gained hands-on experience with front-end and back-end development using Java (Spring and Quarkus), Python, TypeScript, React, Next.js, MySQL, and REST APIs, while also practicing Git for version control and applying clean code principles. My projects have included accessibility tools for visually impaired people, sustainability apps for carbon footprint tracking, and AI-driven predictive systems for flood alerts — experiences that showed me how technology can go beyond code and create meaningful impact.  
